...
/** @hide */
	...
	public MvxActionBarDrawerToggle (android.app.Activity p0, androidx.drawerlayout.widget.DrawerLayout p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == MvxActionBarDrawerToggle.class) {
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Views.AppCompat.MvxActionBarDrawerToggle, MvvmCross", "Android.App.Activity, Mono.Android:AndroidX.DrawerLayout.Widget.DrawerLayout, Xamarin.AndroidX.DrawerLayout:System.Int32, System.Private.CoreLib:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2, p3 });
		}
	}
